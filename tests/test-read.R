...
test_that("Read and parse the issue data.", {
    ...
    ## build the expected data.frame
    issue.data.expected = data.frame(issue.id = c(rep("<issue-jira-ZEPPELIN-328>", 14), rep("<issue-jira-ZEPPELIN-332>", 7),
                                                  rep("<issue-github-3>", 9), rep("<issue-github-6>", 11),
                                                  rep("<issue-github-1>", 6), rep("<issue-github-2>", 5), rep("<issue-github-4>", 3)),
                                     issue.title = c(rep("[ZEPPELIN-328] Interpreter page should clarify the % magic syntax for interpreter group.name", 14),
                                                     rep("[ZEPPELIN-332] CNFE when running SQL query against Cassandra temp table", 7),
                                     ...
                                     issue.type = I(c(rep(list(list("issue" , "bug")), 14), rep(list(list("issue" , "bug")), 7),
                                     ...
                                     issue.state = c(rep("closed", 14), rep("open", 7), rep("closed", 9), rep("open", 11),
                                                     rep("reopened", 6), rep("closed", 5), rep("open", 3)),
                                     issue.resolution = I(c(rep(list(list("fixed")), 14), rep(list(list("unresolved")), 7),
                                                            rep(list(list()), 9), rep(list(list()), 11),
                                                            rep(list(list()), 6), rep(list(list()), 5), rep(list(list()), 3))),
                                     creation.date = get.date.from.string(c(rep("2013-04-21 23:52:09", 14),
                                                                            rep("2016-07-12 16:01:30", 7),
                                     ...
                                     closing.date = get.date.from.string(c(rep("2013-05-25 20:02:08", 14), rep(NA, 7),
                                                                           rep("2016-07-12 16:06:30", 9), rep(NA, 11),
                                                                           rep(NA, 6),
                                                                           rep("2016-07-12 16:04:59", 5),
                                                                           rep(NA, 3))),
                                     issue.components = I(c(rep(list(list("GUI" , "Interpreters")), 14), rep(list(list("Interpreters")), 7),
                                                            rep(list(list()), 9), rep(list(list()), 11),
                                                            rep(list(list()), 6), rep(list(list()), 5), rep(list(list()), 3))),
                                     event.name = c("created", "commented", "commented", "commented", "commented", "commented",
                                                    ...
                                                    "resolution_updated", "referenced_by", "add_link", "created", "commented", "commented", "commented", "commented",
                                                    "commented", "created", "assigned", "commented", "state_updated", "add_link", "referenced",
                                                    "referenced", "add_link", "add_link", "mentioned", "subscribed", "commented", "mentioned",
                                                    "subscribed", "add_link", "mentioned", "subscribed", "labeled", "commented", "referenced_by",
                                                    "created", "commented", "state_updated", "commented", "commented", "state_updated",
                                                    "created", "commented", "merged", "state_updated",
                                                    "referenced_by", "commit_added", "created", "commented"),
                                     author.name = c("Thomas", "Thomas", "Björn", "Björn", "Björn", "Björn", "Olaf", "Björn",
                                                     "Björn", "Olaf", "Olaf", "Olaf", "Björn", "Thomas", "Thomas", "Björn", "Björn", "Björn", "Max",
                                                     "Max", "Max", "Karl", "Olaf", "Karl", "Olaf", "Karl", "Karl", "Thomas", "Karl", "Thomas", "udo",
                                                     "udo", "Thomas", "Björn", "Björn", "Thomas", "Björn", "Björn", "Olaf", "Björn",
                                                     "Karl", "Thomas", "Thomas", "Thomas", "Olaf", "Björn", "Olaf",
                                     ...
                                     author.email = c("thomas@example.org", "thomas@example.org", "bjoern@example.org",
                                                      ...
                                                      "bjoern@example.org", "thomas@example.org", "thomas@example.org", "bjoern@example.org",
                                     ...
                                     event.info.1 = c("open", "open", "open", "open", "open", "open", "open", "open", "open",
                                                      "open", "open", "open", "fixed", "<issue-jira-ZEPPELIN-332>",
                                                      "<issue-jira-ZEPPELIN-328>", "open", "open", "open", "open", "open", "open", "open",
                                     ...
                                     issue.source = c(rep("jira", 21), rep("github", 20), rep("github", 14)),
    ...
    issue.data.expected[["event.info.2"]] = I(list(
                                                ...
                                                list("unresolved"), list("unresolved"), list("unresolved"), list("unresolved"),
                                                list("unresolved"), list("unresolved"), list("unresolved"), list("unresolved"),
                                                "unresolved", "issue", "issue", list("unresolved"), list("unresolved"), list("unresolved"),
                                                list("unresolved"), list("unresolved"), list("unresolved"), list(), "", list(), "open",
                                                "commit", "", "", "issue", "issue", "thomas@example.org", "thomas@example.org", list(),
...
test_that("Read the commit-interactions data.", {
    ...
    commit.interactions.data.expected = data.frame(func = c("test.c", "test2.c", "test2.c", "test2.c"),
                                     commit.hash = c("5a5ec9675e98187e1e92561e1888aa6f04faa338",
                                                     ...
                                                     "c6954cb75e3eeec5b827f64e97b6a4ba187c0d55"),
